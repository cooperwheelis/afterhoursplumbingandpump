...
const content = cityBySlug("burlington-nc");
const pageUrl = url("/service-areas/burlington-nc");

export const Route = createFileRoute("/service-areas/burlington-nc")({
  head: () => ({
    meta: [
...
function Page() {
  return <CityPage content={cityBySlug("burlington-nc")} />;
}
