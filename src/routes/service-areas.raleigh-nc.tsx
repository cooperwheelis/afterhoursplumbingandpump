...
const content = cityBySlug("raleigh-nc");
const pageUrl = url("/service-areas/raleigh-nc");

export const Route = createFileRoute("/service-areas/raleigh-nc")({
  head: () => ({
    meta: [
...
function Page() {
  return <CityPage content={cityBySlug("raleigh-nc")} />;
}
