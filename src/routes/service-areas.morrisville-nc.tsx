...
const content = cityBySlug("morrisville-nc");
const pageUrl = url("/service-areas/morrisville-nc");

export const Route = createFileRoute("/service-areas/morrisville-nc")({
  head: () => ({
    meta: [
...
function Page() {
  return <CityPage content={cityBySlug("morrisville-nc")} />;
}
