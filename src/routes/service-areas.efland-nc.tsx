...
const content = cityBySlug("efland-nc");
const pageUrl = url("/service-areas/efland-nc");

export const Route = createFileRoute("/service-areas/efland-nc")({
  head: () => ({
    meta: [
...
function Page() {
  return <CityPage content={cityBySlug("efland-nc")} />;
}
