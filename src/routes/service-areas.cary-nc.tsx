...
const content = cityBySlug("cary-nc");
const pageUrl = url("/service-areas/cary-nc");

export const Route = createFileRoute("/service-areas/cary-nc")({
  head: () => ({
    meta: [
...
function Page() {
  return <CityPage content={cityBySlug("cary-nc")} />;
}
