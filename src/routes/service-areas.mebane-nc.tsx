...
const content = cityBySlug("mebane-nc");
const pageUrl = url("/service-areas/mebane-nc");

export const Route = createFileRoute("/service-areas/mebane-nc")({
  head: () => ({
    meta: [
...
function Page() {
  return <CityPage content={cityBySlug("mebane-nc")} />;
}
